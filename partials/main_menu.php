        ...
        <div class="row">
            ...
            <div class="col-8">
                <div class="upper">
                    ...
                    <div class="basket">
                        <svg id="Icon_ionic-ios-cart" data-name="Icon ionic-ios-cart" xmlns="http://www.w3.org/2000/svg" width="28.441" height="26.269" viewBox="0 0 28.441 26.269">
                            <path id="Path_1" data-name="Path 1" d="M11.624,29.156a1.031,1.031,0,1,1-1.031-1.031,1.031,1.031,0,0,1,1.031,1.031Z" transform="translate(-3.259 -3.917)" fill="#fff"/>
                            <path id="Path_2" data-name="Path 2" d="M27.409,29.156a1.031,1.031,0,1,1-1.031-1.031,1.031,1.031,0,0,1,1.031,1.031Z" transform="translate(-1.35 -3.917)" fill="#fff"/>
                            <path id="Path_3" data-name="Path 3" d="M31.813,9.512a.41.41,0,0,0-.356-.309L9.182,6.889a.682.682,0,0,1-.513-.345,7.561,7.561,0,0,0-.834-1.367c-.527-.691-1.518-.669-3.338-.683A1.024,1.024,0,0,0,3.382,5.529,1.008,1.008,0,0,0,4.449,6.565a8.471,8.471,0,0,1,1.778.14c.321.1.581.669.677,1.161a.028.028,0,0,0,.007.022c.014.088.137.75.137.757L9.784,24.2a5.953,5.953,0,0,0,.992,2.624,2.668,2.668,0,0,0,2.25,1.191H29.207a1,1,0,0,0,.985-.985.994.994,0,0,0-.957-1.073H13.012a.758.758,0,0,1-.568-.206,3.4,3.4,0,0,1-.787-1.911l-.294-1.742a.04.04,0,0,1,.027-.044L30.383,18.6a.418.418,0,0,0,.335-.382L31.813,9.7A.45.45,0,0,0,31.813,9.512Z" transform="translate(-3.382 -4.493)" fill="#fff"/>
                        </svg>
                    </div>
                    <div class="buttons">
                        <a href="#" class="siteCTA no-arrow">Sign Up</a>
                        <a href="#" class="siteCTA no-arrow">Log In</a>
                    </div>
                </div>
                <div class="lower">
...
<header class="<?=$hc;?> d-block d-lg-none">
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <button type='button' data-bs-toggle='collapse' data-bs-target='.navbar-collapse' id='nav-btn' class='navbar-toggler ml-auto menu' aria-label='Menu Button'>

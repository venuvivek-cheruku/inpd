                        ...
                        <?php if( have_rows('column_4', 'option') ) : while( have_rows('column_4', 'option') ) : the_row(); ?>
                            <div class="col-12 col-lg-4 offset-lg-1">
                                ...
                                <div class="social-icons">
                                    ...
                                    <?php endif; ?>
                                    <?php if( $fb ) : ?>
                                        <a class="fb-link" href="<?=$li;?>" target="_blank"><img src="/wp-content/uploads/2024/06/facebook.svg" alt="Facebook Icon" class="img-fluid"></a>
                                    <?php endif; ?>
                                    <?php if( $yt ) : ?>
                                        <a class="yt-link" href="<?=$li;?>" target="_blank"><img src="/wp-content/uploads/2024/06/youtube.svg" alt="YouTube Icon" class="img-fluid"></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endwhile; endif; ?>

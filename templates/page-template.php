...
?>
    ...
    <?php if( have_rows('page_content') ): ?>
        <?php while( have_rows('page_content') ): the_row(); ?>
            ...
            <?php if( get_row_layout() == 'top_row_with_bg' ): ?> <!-- NEEDS CODE ADDING IN -->
            ...
            <?php elseif( get_row_layout() == 'title_with_icons' ) : ?> <!-- Title With Icons -->
                <?php 
                    ...
                    $icon_count = count( get_sub_field('icon_items') );
                ?>
            ...
            <?php elseif( get_row_layout() == 'boxed_top_row' ) : ?> <!-- Boxed Top Row -->
                <section class="boxed-top-row" style="background: url('<?=get_sub_field('btr_bg');?>') no-repeat center center / cover;">
                    <div class="container">
                        <div class="row">
            ...
            <?php elseif( get_row_layout() == 'vacancies_row' ) : ?> <!-- Vacancies Row -->
                <section class="vacancies dark-blue-bg">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="title text-center">
                                    <p class="white-underline px-3">Vacancies</p>
                            ...
                            <div class="col-12">
                                ...
                                <div class="course-wrapper">
                                    <div class="single-course">
                                        <div class="top">
                                            <img src="/wp-content/uploads/2024/08/Mask-Group-27.png" alt="Card Header" class="img-fluid">
                                        </div>
                                        <div class="content">
                                            <p class="course-class">Directors</p>
                                            <h4>Directors Development Programme Accelerator</h4>
                                            <p>The programme is designed to support and provide leaders with the knowledge and skills to be a high performing…</p>
                                            <div class="meta">
                                                <p class="ftf">Face to face</p>
                                                <p class="type">Virtual</p>
                                                <p class="time">5 days</p>
                                            </div>
                                            <a href="#" class="siteCTA">Visit course</a>
                                        </div>
                                    </div>
                                </div>
                                <?php 
                                    $course_btn = get_sub_field('course_btn'); if( $course_btn ) : 
                                        $course_btn_txt = $course_btn['title'];
                                        $course_btn_url = $course_btn['url'];
                                        $course_btn_trgt = $course_btn['target'] ? $course_btn['target'] : '_self';
                                ?>
                                    <div class="text-center mt-5">
                                        <a href="<?=$course_btn_url;?>" target="<?=$course_btn_trgt;?>" class="siteCTA blue"><?=$course_btn_txt;?></a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>

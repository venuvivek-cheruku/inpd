...
<section class="boxed-top-row"
    style="background: url('http://inpd.local:8888/wp-content/uploads/2024/07/inhousetrain.webp') no-repeat center center / cover;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="course-wrapper">
                    <div class="single-course">
                        <div class="top">
                            <img src="/wp-content/uploads/2024/08/Mask-Group-27.png" alt="Card Header"
                                class="img-fluid">
                        </div>
                        <div class="content">
                            <p class="course-class">Directors</p>
                            <h4>Directors Development Programme Accelerator</h4>
                            <p>The programme is designed to support and provide leaders with the knowledge and skills to
                                be a high performing…</p>
                            <div class="button-wrapper mt-4">
                                <a href="#" class="siteCTA blue-border">Visit course</a>
                            </div>
                        </div>
                    </div>
                    <div class="single-course">
        ...
        <div class="row">
            <div class="float-vid">
                <div class="video-img" data-aos="fade-right">
                    <img src="http://inpd.local:8888/wp-content/uploads/2024/07/placeholder.jpg" alt=""
                        class="img-fluid">
                    <div class="vid-btn">

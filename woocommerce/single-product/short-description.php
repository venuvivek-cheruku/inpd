...
<div class="course-info">
    <div class="course-details">
        ...
        <div class="course-item">
            ...
            <h5>Location:</h5>
            <p>Virtual / Central London / Central Manchester</p>
        </div>
        ...
        <div class="course-item">
            ...
            <h5>Qualification:</h5>
            <p>Postgraduate Certificate in Strategic Leadership for Directors - Optional</p>
        </div>
    </div>
</div>

<a class="right-for-you-text" href="#"> Is this course right for you? </a>

<div class="course-actions">
    <a id="courseVariantsOpenModal" class="siteCTA blue">Book your place</a>
    <a href="#" class="siteCTA blue-border">Ask a question</a>
</div>
